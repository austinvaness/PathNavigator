    ...
    partial class Program
    {
        class ThrusterControl
        {
            ...
            public void Update ()
            {
                ...
                Vector3D thrust = GetShipMass() * ((deltaV / Clock.SecondsPerTick) + gravity);//(2 * deltaV + gravity);
            ...
            /// </summary>
            public Vector3D StopDistance (double accuracy, Vector3D finalVelocity, out bool canAccel)
            {
